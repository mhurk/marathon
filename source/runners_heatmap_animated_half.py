...
def map_distance_to_coords(distances, route_coords, default_start_coord):
    ...
    max_distance = 21.1  # Marathon distance in km
...
def create_heatmap_with_time(runner_coords_over_time, route_coords, bounds, output_html='../images/runner_heatmap_with_time_half.html'):
    ...
    folium.PolyLine(locations=route_coords, color='purple', weight=2).add_to(m)
...
max_time = 180 + 90  # Maximum time in minutes (180 for half marathon, 360 for full). Duration of start waves needs to be added.
...
# Read GPX file
route_coords = load_gpx_route("../gpxfiles/Course_Marathon_Eindhoven_2024_half.gpx")
