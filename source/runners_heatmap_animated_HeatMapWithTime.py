...
def map_distance_to_coords(distances, route_coords, default_start_coord):
    ...
    max_distance = 26.2  # Marathon distance in miles
...
def create_heatmap_with_time(runner_coords_over_time, route_coords, bounds, output_html='../images/runner_heatmap_with_time.html'):
...
# Read GPX file
route_coords = load_gpx_route("../gpxfiles/Course_Marathon_Eindhoven_2024.gpx")
